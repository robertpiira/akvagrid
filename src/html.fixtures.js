export const desktopAbove = `
  <div class="akva-grid akva-grid-desktop-and-above" style="max-width: 1200px; width: 92%; opacity: 0.5; z-index: 1;">
...
export const mobileAndTablet = `
  <div class="akva-grid akva-grid-mobile-and-tablet" style="max-width: 1200px; opacity: 0.5; z-index: 1;">
